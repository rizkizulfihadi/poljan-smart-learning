...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    const getParentIndex = () => {
        ...
        try {
            while(commentsArr[array].childrenLevel >= commentData.childrenLevel){
                array--;
            }
        } catch {
            array = undefined;
    ...
    const removeCommentsCards = (array, isDelete = false) => {
        if(commentsArr[array]){
            while( commentsArr[array].childrenLevel > commentData.childrenLevel ){
                commentsArr.splice(array, 1);
