...
import { ManageDraftBlogPost, ManageNonActiveBlogCard, ManagePublishedBlogCard } from "../components/manage-blogcard.component";
...
const ManageBlogs = () => {
    ...
    return (
        <>
            ...
            <InpageNavigation routes={["Artikel diterbitkan", "Draf", "Ditangguhkan"]} defaultActiveIndex={ activeTab ===  'draft' ?  1 : activeTab === 'Ditangguhkan' ? 2 : 0}>
                { // published blogs
                    blogs == null ? <Loader /> :
                ...
                { // draft blogs
                    ...
                    drafts.results.length ? 
                        ...
                        <LoadMoreDataBtn state={drafts} fetchDataFun={getBlogs} additionalParam={{ draft: true, active: true, deletedDocCount: drafts.deletedDocCount }} />
                        </>
                    : <NoDataMessage message="Tidak ada draf disini" />
                }
