                ...
                profile_username.length ?
                    <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
                        <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-1 border-grey md:sticky md:top-[100px] md:py-10">
                            ...
                            <p>{total_posts.toLocaleString()} Artikel - {total_reads.toLocaleString()} Dibaca</p>
                        ...
                        <InpageNavigation routes={["Artikel Diterbitkan", "Tentang"]} defaultHidden={["Tentang"]}>
                            ...
                            <>
                                {
                                    ...
                                    : <NoDataMessage message="Belum ada artikel yang di terbitkan" />
                                }
                                <LoadMoreDataBtn 
                                    state={blogs} 
